...
export const ROADMAP_THEMES: Record<string, RoadmapTheme> = {
  ...
  changelog: {
    id: 'changelog',
    name: 'Changelog',
    description: 'Date-stamped entries on a left rail. Pure editorial, no cards.',
    bg: '#0c0c0c',
    surface: '#141414',
    surfaceAlt: '#1a1a1a',
    border: '#242424',
    ...
    accent: '#c8c8c8',
    accentAlt: '#666',
    status: { backlog: '#3a3a3a', in_progress: '#888', qa: '#666', completed: '#c8c8c8' },
  ...
  newspaper: {
    id: 'newspaper',
    name: 'Newspaper',
    description: 'Editorial two-column layout. Typographic hierarchy, no cards.',
    bg: '#0d0d0d',
    surface: '#111',
    surfaceAlt: '#141414',
    border: '#2a2a2a',
  ...
  accordion: {
    id: 'accordion',
    name: 'Accordion',
    description: 'Animated expand/collapse with progress bars and status counts.',
    bg: '#09090b',
  ...
  magazine: {
    id: 'magazine',
    name: 'Magazine',
    description: 'Hero version dominates top, smaller tiles below. Editorial grid.',
    bg: '#080808',
    bgGradient: 'linear-gradient(180deg, #0a0a0a 0%, #080808 100%)',
    surface: '#111',
    surfaceAlt: '#161616',
    border: '#1e1e1e',
    text: '#e0e0e0',
    ...
    accent: '#9a8a6a',
    accentAlt: '#c8b890',
    status: { backlog: '#2a2a2a', in_progress: '#6a5a3a', qa: '#4a3a2a', completed: '#2a4a2a' },
    font: '"Libre Baskerville", "Georgia", serif',
    layout: 'magazine',
  },

  // ── STRUCTURAL: navigation-based ────────────────────────────────────────
  ...
  swimlane: {
    id: 'swimlane',
    name: 'Swimlane',
    description: 'Horizontal scroll — each version is a lane, tasks flow left to right.',
    bg: '#06080e',
    bgGradient: 'linear-gradient(180deg, #06080e 0%, #080b14 100%)',
    surface: '#0e1018',
    surfaceAlt: '#12151f',
    border: '#1c2030',
    text: '#b8c4d8',
    ...
    accent: '#3a6a8a',
    accentAlt: '#5a8aaa',
    status: { backlog: '#1a2030', in_progress: '#1a3a5a', qa: '#2a1a4a', completed: '#0a2a1a' },
    font: '"Inter", sans-serif',
    layout: 'swimlane',
  },

  // ── STRUCTURAL: radial/spatial ───────────────────────────────────────────
  ...
  codeblock: {
    id: 'codeblock',
    name: 'Code Block',
    description: 'Looks like a code diff / PR review. Line numbers, diff markers.',
    bg: '#0d1117',
    bgGradient: 'linear-gradient(180deg, #0d1117 0%, #0a0e14 100%)',
    surface: '#161b22',
    surfaceAlt: '#1c2128',
    border: '#30363d',
    text: '#c9d1d9',
    ...
    accent: '#58a6ff',
    accentAlt: '#79c0ff',
    status: { backlog: '#21262d', in_progress: '#1f4068', qa: '#3d1f6e', completed: '#0f3d1f' },
