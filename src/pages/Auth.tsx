            ...
            <Card className="glass p-8">
              ...
              <Tabs defaultValue="login" className="w-full">
                ...
                <TabsContent value="login" className="space-y-4">
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full flex items-center justify-center gap-3 bg-slate-800/50 hover:bg-slate-700/50 text-white border-slate-600 hover:border-slate-500 transition-all"
                ...
                <TabsContent value="register" className="space-y-4">
                  <form onSubmit={handleSignUp} className="space-y-4">
                    ...
                    <div className="flex items-start space-x-2 p-4 border rounded-lg border-primary/30 bg-primary/5">
                      <input
                        type="checkbox"
                        id="tos-agreement"
                        checked={agreedToTOS}
                        ...
                        required
                      />
                      <Label htmlFor="tos-agreement" className="text-sm leading-relaxed">
                        I have read and agree to the{" "}
                        <Link to="/tos" className="text-primary hover:underline font-medium" target="_blank">
                          Terms of Service
                        </Link>
                        {" "}and understand that all moderation decisions are at Vectabase's sole discretion.
                      </Label>
                    </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-muted-foreground">
                  ...
                  <Link to="/tos" className="text-primary hover:underline">Terms of Service</Link>
                  {" "}and{" "}
